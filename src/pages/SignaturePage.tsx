...
const SignaturePage = () => {
  ...
  const handleFile = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = () => {
      ...
      img.onload = () => {
        // Draw on canvas to ensure PNG with transparency support
        const canvas = document.createElement("canvas");
        canvas.width = img.width;
        canvas.height = img.height;
        const ctx = canvas.getContext("2d")!;
        // Transparent background by default (canvas is transparent)
    ...
    <div className="container mx-auto px-4 py-8 max-w-lg animate-fade-in">
      ...
      {saved && (
        <div className="bg-card border rounded-xl p-6 mb-6 text-center">
          ...
          <div className="inline-block border-2 border-dashed border-primary/30 rounded-lg p-4 bg-white">
      ...
      {preview && (
        <div className="bg-card border rounded-xl p-6 mt-6 text-center">
          ...
          <div className="inline-block border rounded-lg p-4 bg-white checkerboard-bg">
